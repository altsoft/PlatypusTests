...
require(['facade'], function (F) {
    ...
    F.cacheBust(true);
    F.export(global);
    require('TestReportsThreeTierView', function(TestReportsThreeTierView){
        var m = new TestReportsThreeTierView();
        m.show();
    }, function(e){
        F.Logger.severe(e);
        if(global.document){
            ...
            messageParagraph.innerHTML = 'An error occured while require(\'TestReportsThreeTierView\'). Error: ' + e;
