/**
 * Естественная сортировка.js
 * @name 131772080982761
 *
 * Created on 04.10.2011, 13:33:29
 * @author ml
 */

/** 
 * Это естественная сортировка (напр., ['f1', 'f10', 'f2'] ->  ['f1', 'f2', 'f10']  )
 */
...
var arr = new Array('f1', 'f10', 'f2');
Logger.info(naturalSort(arr));